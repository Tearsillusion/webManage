const articleDetails = async (req,res,sqlMain,moment,baseUrl,selectUser) => {
	...
	'community.id,public_status,article_type,delete_status,nickName,avatar,title,content,image_path,community.create_time,priview_address,code_address,star_status','user',"community",
